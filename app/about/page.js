...
export default function AboutPage() {
  return (
    <main id="content" className="relative flex min-h-[calc(100dvh-86px)] items-center overflow-x-hidden px-4 py-8 text-white sm:px-6 md:py-10">
      ...
      <section className="mx-auto my-auto grid w-full max-w-6xl items-center gap-6 rounded-[2rem] border border-white/15 bg-[linear-gradient(155deg,rgba(255,214,160,0.1),rgba(255,214,160,0.01)_34%),rgba(0,0,0,0.32)] p-5 shadow-[0_40px_100px_-70px_rgba(0,0,0,0.9)] backdrop-blur sm:p-7 lg:grid-cols-[0.65fr_1fr] lg:p-9">
        <motion.div
        ...
        >
          ...
          <h1 className="mt-4 bg-gradient-to-b from-white via-[#ffefda] to-[#f0bf7f] bg-clip-text font-display text-[clamp(2rem,7.5vw,3.2rem)] leading-[1.04] text-transparent">Qamrul Hassan Shajal</h1>
          ...
          <div className="mt-6 grid max-w-xl grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-3">
