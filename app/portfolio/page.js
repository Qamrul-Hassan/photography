  ...
  return (
    <main id="content" className="relative min-h-screen overflow-x-hidden px-4 py-14 text-white sm:px-6 sm:py-16">
      ...
      <section className="mx-auto w-full max-w-6xl text-center">
        ...
        <h1 className="mt-4 bg-gradient-to-b from-white via-[#ffefda] to-[#f0bf7f] bg-clip-text font-display text-[clamp(2rem,8vw,3.7rem)] leading-[1.03] text-transparent">Signature Collection</h1>
        ...
        <div className="relative mt-10 overflow-hidden rounded-[2rem] border border-white/15 bg-[linear-gradient(150deg,rgba(255,214,160,0.1),rgba(255,214,160,0.01)_35%),rgba(0,0,0,0.4)] p-2 shadow-[0_40px_130px_-70px_rgba(255,130,35,0.75)]">
          <div className="relative h-[52vh] min-h-[300px] w-full overflow-hidden rounded-[1.5rem] sm:h-[58vh] sm:min-h-[360px]">
